<div id="cancellation-modal" class="c-modal">
    <div class="c-modal-content c-cancel-modal">
        ...
        <div style="text-align: center; margin-top: 10px;">
            <textarea onkeyup="getTextValue(this)" id="inputReason" class="c-inputText" maxlength="50" style="width: 100%; height: 80px;" placeholder="Leave a remarks.."></textarea>
            <p class="h-alert-text" id="alertTextReason" style="text-align: left;">Max.50 character</p>
        </div>

        <div class="c-modal-footer" style="text-align: right; margin-top: 10px">
            <button onclick="returnModalHide(this)" class="c-btn-white" style="width: 100px;">CANCEL</button>
